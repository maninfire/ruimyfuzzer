...
**Code**
  * Current version: 0.5 ([ChangeLog](http://code.google.com/p/honggfuzz/source/browse/trunk/ChangeLog)) - using a fresh version from the code repository is strongly suggested
